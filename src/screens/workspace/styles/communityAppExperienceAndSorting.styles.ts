export const styleSource = {
  ...
  communitySortButtonText: { color: "#A6ADBA", fontSize: 12, fontWeight: "900" },
  communitySortMenu: {
      alignSelf: "flex-end",
  ...
  communitySortOptionActive: {
      backgroundColor: "rgba(255, 255, 255, 0.08)"
    },
  communitySortOptionText: {
      color: "#A6ADBA",
      fontSize: 13,
      fontWeight: "800"
    },
  communitySortOptionTextActive: {
      color: "#F5F7FA"
    }
} as const;
