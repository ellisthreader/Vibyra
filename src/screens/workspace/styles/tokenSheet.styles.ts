...
export const styleSource = {
  tokenRenewalBadge: {
      ...
      borderColor: "rgba(145, 167, 255, 0.22)",
      borderRadius: 999,
      borderWidth: 1,
      flexDirection: "row",
      gap: 6,
  ...
  tokenSheetClose: {
      alignItems: "center",
      backgroundColor: "rgba(91, 124, 250, 0.18)",
      borderColor: "rgba(145, 167, 255, 0.16)",
      borderRadius: 10,
      borderWidth: 1,
      height: 36,
  ...
  tokenSheetHandle: {
      alignSelf: "center",
      backgroundColor: "rgba(145, 167, 255, 0.32)",
      borderRadius: 999,
      height: 4,
      width: 42
    },
  ...
  tokenSheetHeaderIcon: {
      ...
      borderColor: "rgba(145, 167, 255, 0.24)",
      borderRadius: 14,
      borderWidth: 1,
      height: 48,
      justifyContent: "center",
  ...
  tokenTrack: {
      backgroundColor: "rgba(91, 124, 250, 0.34)",
      borderRadius: 999,
      height: 10,
      overflow: "hidden"
    },
