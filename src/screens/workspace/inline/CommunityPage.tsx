...
import { CommunityOpenedAppPage, hasCommunityRunnableDemo } from "./CommunityAppExperience";
...
export function CommunityPage({
  ...
  const searchIconColor = useThemedColor("#A6ADBA");
  const filterIconColor = useThemedColor("#A6ADBA");
  ...
  if (selectedPost) {
    ...
    return (
      <>
        ...
        />
        <CommunityReportModal authToken={authToken} post={reportPost} visible={Boolean(reportPost)} onClose={() => setReportPost(null)} />
      </>
    );
  }
