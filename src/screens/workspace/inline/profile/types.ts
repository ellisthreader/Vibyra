...
export type SheetKind =
  ...
  | "security" | "language" | "cache" | "help" | "support" | "terms" | "logout" | "deleteAccount";
...
export const PLAN_TIERS: PlanTier[] = [
  ...
  { key: "starter", name: "Starter", tagline: "Ship your first real build",
    price: "£20", cadence: "per month",
    annualPrice: "£225", annualCadence: "per year",
  ...
  { key: "builder", name: "Builder", tagline: "Daily building, no ceilings",
    ...
    annualSubtext: "£48.75/mo · save £3",
    tokens: "1,000 credits / month", annualTokens: "1,000 credits / month",
    badge: "Most popular",
  ...
  { key: "pro", name: "Pro", tagline: "Multi-agent power-user workflows",
    ...
    annualSubtext: "£97.50/mo · save £18",
    tokens: "2,000 credits / month", annualTokens: "2,000 credits / month",
    perks: ["All models, priority routing", "10 projects, 4 concurrent agents", "Highest daily cap, fewest rate limits", "Same monthly credits on annual billing"],
