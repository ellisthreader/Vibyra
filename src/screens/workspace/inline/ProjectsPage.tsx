...
import { ProjectFilterMenuItem } from "./ProjectMenuComponents";
...
export function ProjectsPage(props: ProjectsPageProps) {
  ...
  const filterIconColor = useThemedColor(p.filterMenuOpen ? "#F5F7FA" : "#A6ADBA");
  const createGradient = prefs.effectiveScheme === "light" ? ["#315BD8", "#2449B8", "#315BD8"] as const : ["#4667E8", "#3D5ACF", "#4667E8"] as const;
