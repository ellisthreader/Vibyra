...
export function ProjectMenuItem({ danger, icon, label, onPress }: {
  ...
  const itemIconColor = useThemedColor(danger ? "#FF7F96" : "#F5F7FA");
  return (
...
export function ProjectFilterMenuItem({ active, label, onPress }: {
  ...
  const checkColor = useThemedColor("#F5F7FA");
  return (
...
export function FolderConfirmModal({ confirm, onAccept, onCancel, onSkip }: {
  ...
  const modalIconColor = useThemedColor("#91A7FF");
  const folderIconColor = useThemedColor("#F5F7FA");
