---
title: AI Team Prompting Research
tags:
  - ai/desktop
  - teams
  - research
...
- Deep reference for Team prompt design across Codex, Claude Code, Gemini CLI, and Vibyra Agent.
- Pair with [[AI Team Role Prompt Specification]] for the implemented role contract and [[AI Team Orchestration Plan]] for runtime sequencing.
- Decisions: use one provider-neutral role contract, one assignment envelope, provider adapters, runtime capability controls, structured artifacts, and sequencing.
- Watchpoints: better prompts alone cannot enforce permissions or repair concurrent lifecycle problems; providers without a verified higher-priority instruction channel must fail Team launch.
