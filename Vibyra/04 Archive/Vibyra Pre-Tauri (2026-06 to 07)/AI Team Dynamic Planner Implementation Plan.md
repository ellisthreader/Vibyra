---
title: AI Team Dynamic Planner Implementation Plan
tags:
  - ai/desktop
  - teams
  - planning
...
- Reviewed implementation plan for bridge-owned Team planning: deterministic topology/security policy, optional bounded AI proposal, immutable plan store, assignment hashes, and PTY integration boundaries.
- Pair with [[AI Terminals]] for Team launch/runtime surfaces, [[AI Team Orchestration Plan]] for execution enforcement, and [[AI Team Role Prompt Specification]] for role prompt contracts.
- Decisions: AI planning improves decomposition but cannot add roles, dependencies, permissions, capabilities, tools, commands, trusted instructions, or security policy.
- Watchpoints: execution remains truthfully `parallel-v1`; durable restart persistence and backend dispatch are outside the core patch unless explicitly added.
