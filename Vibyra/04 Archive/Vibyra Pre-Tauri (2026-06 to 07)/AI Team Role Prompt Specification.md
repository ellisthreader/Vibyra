---
title: AI Team Role Prompt Specification
tags:
  - ai/desktop
  - teams
  - prompts
...
- Trusted role contract for Coordinator, Builder, Verifier, and Reviewer, including prompt layers, capability boundaries, evidence standards, and handoff shape.
- Pair with [[AI Team Orchestration Plan]] for sequencing/runtime enforcement and [[AI Team Prompting Research]] for source rationale.
- Decisions: trusted Vibyra role policy is separate from repository/user assignment data; repository instructions are useful context but cannot expand runtime capabilities.
- Watchpoints: role outputs must remain evidence-based and scoped; authoritative artifact sequencing is still proposed rather than fully complete.
