---
title: AI Team Orchestration Plan
tags:
  - ai/desktop
  - teams
  - orchestration
...
- Execution contract for turning Team mode into a sequenced, evidence-driven workflow rather than unrelated parallel terminals.
- Pair with [[AI Team Dynamic Planner Implementation Plan]] for untrusted decomposition data and [[AI Team Role Prompt Specification]] for trusted role prompts.
- Decisions: do not market/display automatic coordination until sequencing, artifact relay, capability enforcement, and authoritative Team state exist.
- Watchpoints: Builder is the sole writer; unsupported Team runtimes fail closed; artifact schema parsing and whole-team launch rollback remain open.
...
[[AI Team Dynamic Planner Implementation Plan]]. That planner is
