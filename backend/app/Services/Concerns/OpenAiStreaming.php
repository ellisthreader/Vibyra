                    ...
                    'messages' => [
                        [
                            ...
                            'content' => implode("\n", [
                                ...
                                'If the user asks for an app, website, page, or visual feature and the project has no obvious web entry, create or update a phone-viewable index.html in the project root. This is a last resort only: for existing framework apps such as Laravel, Inertia, Vite, React, Next, Vue, Svelte, Astro, or similar, do not create a new root index.html unless it already is the real entry file. Modify the existing framework entry, route, view, component, auth/session, or asset files instead.',
                                'When fixing a preview crash for an existing desktop project, preserve the project structure. Do not replace the app with a detached static page or self-contained <vibyra-app>.',
