...
#[tauri::command]
pub async fn fs_create_project_folder(parent: String, name: String) -> Result<String, CoreError> {
    run_blocking_core(move || fsx::project_folder::create_project_folder(&parent, &name)).await
}
