...
import "./styles/project-new-steps.css";
import "./styles/project-new-browse.css";
import "./styles/project-new-review.css";
import "./styles/project-new-build.css";
...
import "./styles/agent-chat-rail.css";
import "./styles/agent-transcript.css";
import "./styles/agent-answer.css";
import "./styles/agent-code-block.css";
import "./styles/agent-tools.css";
import "./styles/agent-turn.css";
import "./styles/agent-changed.css";
import "./styles/agent-composer.css";
import "./styles/agent-panels.css";
import "./styles/agent-lists.css";
...
import "./styles/agent-provenance.css";
import "./styles/agent-skills.css";
import "./styles/agent-settings.css";
import "./styles/agent-memory.css";
import "./styles/agent-extras.css";
import "./styles/agent-mail.css";
...
import "./styles/settings-vault.css";
import "./styles/companion-ask.css";
import "./styles/companion-ask-workspace.css";
import "./styles/companion-ask-voice.css";
import "./styles/companion-ask-composer.css";
