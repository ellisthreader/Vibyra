...
/** Floating above the form, with one bounded native scrolling list. */
export function LaunchModelMenu({ anchor, models, selectedId, onSelect, onClose, onBrowseAll }: Props) {
  const [query, setQuery] = useState('');
  const style = useModelPopover(anchor, onClose);
  ...
  return createPortal(<div className="launch-model-browser" style={style} ref={root} onKeyDown={event => {
