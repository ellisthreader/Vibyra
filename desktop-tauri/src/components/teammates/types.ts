export interface Teammate { id: string; chatId: string; revision: number; name: string; brief: string; memory: string; avatar: string; budget: number; integrations: string[]; archived: boolean; status: string; lastMessage: string; updatedAt: string; unread?: boolean; readCursor?: string; execution?: string | null }
