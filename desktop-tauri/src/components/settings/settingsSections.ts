...
export const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  { id: "iphone", label: "iPhone", icon: PhoneIcon, tile: "#2f9e6b" },
...
const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  { label: "OpenAI API key", keywords: "key chat voice dictation vibyra ai companion", section: "ai", panel: "vibyraFeatures" },
  { label: "Usage and spend limits", keywords: "spend cap budget usage cost money limit requests", section: "ai", panel: "usage" },
  ...
  { label: "iPhone connection", keywords: "phone remote mobile pair bonjour nearby", section: "iphone" },
  { label: "Typing from your phone", keywords: "phone type input permission", section: "iphone" },
  { label: "Remote access", keywords: "cloud anywhere relay cellular network", section: "iphone" },
  { label: "Vault folder", keywords: "obsidian notes markdown read-only phone", section: "iphone" },
