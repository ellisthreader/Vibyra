...
fn main(){
 let out=PathBuf::from("/tmp/vibyra-performance-implementation-20260904-zoqgldu3");
 ...
 for count in [0,100,1000,3000] {
  ...
  drop(watcher); assert_eq!(watch_count(), before, "watch registration leaked after drop");
 }
