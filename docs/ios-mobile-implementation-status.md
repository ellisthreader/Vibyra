...
Updated 6 September 2026. This records the foundation and conversation-first redesign of
...
The [redesign gallery](../tmp/ios-redesign/index.html) shows the new home,
...
Mobile: 28 focused tests and all 21 Expo Doctor checks passed, alongside
...
`mobile/scripts/verify-*.mjs` checks for the exact journeys.
