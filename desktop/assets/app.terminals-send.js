...
function handleLocalSlashCommand(terminal, command, args, profile) {
  ...
  if (command === "/voice") { if (typeof openTerminalAiVoice === "function") openTerminalAiVoice("terminal"); appendTerminalMessages(terminal, [makeTerminalMessage("system", "Opened Talk to Vibyra in the AI sidebar.", { type: "tool", provider: profile.key, meta: { command } })], { clearDraft: true }); return { handled: true }; }
