...
function storeDesktopAuthSession(token, user) {
  ...
  localStorage.setItem(authKey, JSON.stringify({
    ...
    user: {
      ...
      creditsResetAt: user.creditsResetAt || user.planRenewsAt || null,
      ...
      canManageStripeBilling: Boolean(user.canManageStripeBilling),
      planPricePence: Number(user.planPricePence) || 0,
      billingCurrency: user.billingCurrency || "gbp",
      billingVatInclusive: user.billingVatInclusive !== false,
