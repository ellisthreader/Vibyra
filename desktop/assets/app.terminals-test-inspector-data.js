function normalizeTerminalTestInspectorElement(value) {
  ...
  return {
    ...
    role: inspectorText(value.role, 80),
    testId: inspectorText(value.testId, 120),
    ariaLabel: inspectorText(value.ariaLabel, 240),
    name: inspectorText(value.name, 120),
    placeholder: inspectorText(value.placeholder, 240),
    title: inspectorText(value.title, 240),
    alt: inspectorText(value.alt, 240),
    href: inspectorText(value.href, 500),
