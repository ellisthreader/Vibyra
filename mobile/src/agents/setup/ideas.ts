...
export const setupIdeas = [
  ...
  ['Research brief', 'Research one topic at a time and separate sourced findings from open questions.'],
  ['Learning coach', 'Help me plan practice sessions around my current level and available study time.'],
  ...
  ['Customer follow-up', 'Turn my customer meeting notes into follow-up drafts without sending them.'],
  ['Weekly priorities', 'Help me review unfinished work and choose a realistic set of priorities.'],
  ['Quiet notifications', 'Help me define which updates deserve an alert and which belong in a digest.'],
