        ...
        >
          {error ??
            (status === 'pending' && !canRespond
              ? 'Take control when connected to respond.'
              : labels[status])}
        </Text>
      )}
    </View>
...
const s = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 16, fontWeight: '600', lineHeight: 21, letterSpacing: -0.3 },
  status: { fontSize: 13, lineHeight: 18, letterSpacing: -0.05 },
});
