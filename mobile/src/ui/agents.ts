...
export const computerAgents: {
...
}[] = [
  {
    ...
    name: 'Claude Code',
    short: 'Claude',
    detail: 'Claude’s CLI, on your computer',
  ...
  },
  {
    ...
    name: 'Codex',
    short: 'Codex',
    detail: 'The Codex CLI, on your computer',
  ...
  },
  {
    ...
    name: 'Terminal',
    short: 'Terminal',
    detail: 'A plain shell, on your computer',
...
export const agentName = (kind: SessionKind) =>
  computerAgents.find((agent) => agent.kind === kind)!.name;
export const modelLabel = (id: string, models: VibesModel[]) =>
  models.find((model) => model.id === id)?.name ?? 'Auto';
