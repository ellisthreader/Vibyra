...
export function ConnectScreen({ visible, workspace, onClose, onConnected, presented }: {
  visible: boolean; workspace: WorkspaceModel; onClose: () => void;
  onConnected?: () => void; presented?: Animated.Value;
}) {
  return visible ? <ConnectionModal onClose={onClose} presented={presented}>
    {dismiss => <ConnectFlow workspace={workspace} onConnected={onConnected} onClose={dismiss} />}
