...
export const isTestAccount = (workspace: WorkspaceModel) =>
  Boolean(workspace.demo && workspace.account);
...
export const sampleNote = (workspace: WorkspaceModel) =>
  isTestAccount(workspace)
    ? 'Test account · nothing here is saved.'
    : 'Sample account · nothing here is saved.';
