...
import { Animated, KeyboardAvoidingView, Modal, Platform, Pressable, ScrollView, StyleSheet,
 ...
 */
export function IntegrationFrame({ visible, onClose, label, footer, children }: {
