  ...
  return (
    <View
      style={[
        ...
        {
          backgroundColor: dark ? '#141927' : '#E8EDF8',
          alignItems: 'center',
    ...
    >
      <View style={[s.desktop, { opacity: dark ? 0.25 : 0.4 }]}>
        {[0.6, 0.82, 0.45].map((fraction, index) => (
          <View
            key={index}
            style={{
              width: `${fraction * 100}%`,
        ...
        {approval ? (
          ...
          >
            ...
            <View style={s.buttons}>
              <View style={[s.button, { backgroundColor: colors.elevated }]}>
                <Text style={[s.buttonText, { color: colors.muted }]}>Deny</Text>
              </View>
              <View style={[s.button, { backgroundColor: colors.action }]}>
                <Text style={[s.buttonText, { color: colors.onAction }]}>Allow</Text>
              </View>
            </View>
            <Animated.View
              style={[
            ...
            >
              <Svg width={19} height={23} viewBox="0 0 19 23">
                <Path
                  d="M3 2V19L8 15L12 22L15 20L11 13L18 12Z"
                  fill={colors.text}
          ...
          <Animated.View style={[s.rest, { opacity: reveal }]}>
            {stage === 'connecting' ? (
              <ActivityIndicator size="small" color={colors.accent} />
            ) : (
              <Icon
                name={stage === 'connected' ? 'checkmark-circle' : 'alert-circle-outline'}
                size={36}
