...
export interface DemoWorkspace extends WorkspaceModel {
  demo: true;
  messages: DemoMessage[];
}
export const isDemoWorkspace = (value: WorkspaceModel): value is DemoWorkspace =>
  value.demo === true;
  ...
  'demo-checkout': [
    {
      id: 'a1',
      role: 'user',
      text: 'Make the checkout feel simpler. Give the order summary a little more breathing room.',
    },
    {
      id: 'a2',
      role: 'assistant',
      text: 'The checkout now gives each decision its own space. I simplified the form, made the order summary easier to scan, and kept the next step clear.',
      result: true,
    },
  ],
  'demo-shortcuts': [
    {
      id: 'b1',
      role: 'user',
      text: 'Add keyboard shortcuts for search and creating a new project.',
    },
    {
      id: 'b2',
      role: 'assistant',
      text: 'The shortcuts are in place: ⌘K for search and ⌘N for a new project. Ready to run the project checks.',
    },
  ],
  'demo-empty': [
    { id: 'c1', role: 'user', text: 'Make the empty states clearer and more welcoming.' },
    {
      id: 'c2',
      role: 'assistant',
      text: 'Each empty state now explains what belongs here and offers one useful next step.',
      result: true,
    },
  ],
};
