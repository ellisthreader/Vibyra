  ...
  return (
    ...
    >
      <Svg width={size} height={size} viewBox="0 0 64 64">
        ...
        <Path
          fill="#FFFFFF"
          d="M12.199 17.883 L19.532 17.883 A2.032 2.032 0 0 1 21.292 18.899 L33.025 39.221 L38.891 29.060 A2.032 2.032 0 0 1 40.651 28.044 L47.984 28.044 A0.508 0.508 0 0 1 48.424 28.806 L40.064 43.285 A8.129 8.129 0 0 1 25.985 43.285 L11.759 18.645 A0.508 0.508 0 0 1 12.199 17.883 Z"
        />
        ...
        <Path
          fill="#FFFFFF"
          d="M46.518 17.883 L53.850 17.883 A0.508 0.508 0 0 1 54.290 18.645 L51.797 22.963 A2.032 2.032 0 0 1 50.037 23.979 L42.704 23.979 A0.508 0.508 0 0 1 42.264 23.217 L44.758 18.899 A2.032 2.032 0 0 1 46.518 17.883 Z"
        />
      </Svg>
    </View>
  );
