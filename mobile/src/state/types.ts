...
export interface HostState {
  ...
  protocol: number;
  capabilities?: {
    conversationV1?: boolean;
    conversationProviders?: string[];
    vibesToolsV1?: boolean;
    scaffoldV1?: boolean;
    previewHttpProofV1?: boolean;
    previewV1?: boolean;
    readOnly?: boolean;
    canInput?: boolean;
    canManage?: boolean;
...
export interface RuntimeDependencies {
  ...
  account: AccountApi;
  uuid(): string;
  iosConversations?: boolean;
  previewNative?: boolean;
...
export const initialState: RuntimeState = {
  ...
  syncing: false,
  control: 'none',
  onboarding: { status: 'unknown', mode: null },
  account: null,
  reconnecting: false,
  viewOnly: false,
  canType: false,
