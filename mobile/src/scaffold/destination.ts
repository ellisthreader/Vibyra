...
// resolved path while it is being typed. The computer still has the last word
// on whether the folder can actually be written; this is the fast, local half.
...
/** The computer's home folder shortened to `~`, the way a terminal prompt shows it. */
