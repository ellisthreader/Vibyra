...
console.log('PASS native components: empty/1/2/6/10/20 panes, modes, preserved hosts, dictation, exact send recovery, maximise and restore, workspace tree New terminal rows.');}finally{await browser.close();server.close();}
