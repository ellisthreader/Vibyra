...
const config: ExpoConfig = {
  ...
  extra: { remoteProtocol: 1, eas: { projectId: 'c009e48d-4c3b-47b9-bcd6-2db120d2596c' }, apiUrl: process.env.EXPO_PUBLIC_API_URL ?? 'https://vibyra-production.up.railway.app' },
};
