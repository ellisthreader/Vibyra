...
4. Exactly one relevant domain note:
...
When you learn durable architecture, workflow, route/API contract, or recurring bug context, update the relevant note in `Vibyra/_ai/`.
